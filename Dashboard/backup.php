...
<body>
    ...
    <div class="page-content p-3" id="content">
        ...
        <center>
            <h2 class="text-white">Total Harga: Rp100,000</h2>
            <br />
            <h4 class="display-4 text-white" style="font-size:20px;">Masukkan kode referral anda</h4>
        </center>
            ...
            <div class="row">
                <div class="col-lg-12 card">
                    ...
                    <div class="form-row justify-content-center py-3">
                        <div>
                            <button class="btn btn-primary btn-block font-weight-bold">Checkout</button>
                        </div>
                    </div>
                    <p class="lead text-primary font-weight-bold mb-0">APA ITU REFERRAL ?</p>
                    ...
                    <p class="lead text-primary font-weight-bold mb-0">BAGAIMANA CARA MEMBUAT AKUN ?</p>
                    <p style="color: black;">Klik ikon profil di kanan atas, pilih Daftar. Isikan data diri kamu, jangan sampai lupa password ya...</p>

                    <p class="lead text-primary font-weight-bold mb-0">PEMBAYARAN VIA APA ?</p>
