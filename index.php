...
<head>
    ...
    <link rel="stylesheet" href="assets/BT/bootstrap/dist/css/bootstrap.min.css">
...
<body>
    ...
    <div class="navigation" id="navb">
        ...
        <div class="login-signup">
            <a href="Login/Registration/regist.php">Sign-up</a>
    ...
    <!-- Educator's logo -->
    <center><img src="assets/img/favicon.ico" width="15%" style="margin-top: 60px;"> </center><br>
    <center>
